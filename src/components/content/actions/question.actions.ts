...
export async function createQuestionAction(topicId: string, data: any) {
  try {
    ...
    console.warn("Failed to create question:", error instanceof Error ? error.message : String(error));
...
export async function updateQuestionAction(id: string, data: any) {
  try {
    ...
    console.warn("Failed to update question:", error instanceof Error ? error.message : String(error));
...
export async function deleteQuestionAction(id: string) {
  try {
    ...
    console.warn("Failed to delete question:", error instanceof Error ? error.message : String(error));
