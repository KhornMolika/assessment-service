...
export async function createAssessmentAction(topicId: string, data: any) {
  try {
    ...
    console.warn("Failed to create assessment:", error instanceof Error ? error.message : String(error));
...
export async function updateAssessmentAction(id: string, data: any) {
  try {
    ...
    console.warn("Failed to update assessment:", error instanceof Error ? error.message : String(error));
...
export async function deleteAssessmentAction(id: string) {
  try {
    ...
    console.warn("Failed to delete assessment:", error instanceof Error ? error.message : String(error));
...
export async function publishAssessmentAction(id: string) {
  try {
    ...
    console.warn("Failed to publish assessment:", error instanceof Error ? error.message : String(error));
