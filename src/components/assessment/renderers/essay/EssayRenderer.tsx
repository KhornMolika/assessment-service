  ...
  return (
    <div className="space-y-2">
      <Textarea
        ...
        className="min-h-56 w-full rounded-2xl border-2 border-border bg-white px-5 py-4 text-sm leading-7 text-primary outline-none transition focus:border-primary disabled:cursor-not-allowed disabled:opacity-60"
      />
      {(minWords || maxWords) ? (
