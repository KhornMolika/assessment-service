...
export default function QuestionBankEditHeader({ formId }: { formId: string }) {
  return (
    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
      <div className="flex flex-row justify-center items-start gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-primary">Edit Question Bank</h1>
          <p className="mt-1 text-sm text-inkd">
            Refine the bank metadata and review how it will appear before saving your changes.
          </p>
        </div>
      </div>
