        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-1 text-xs text-inkd">{question.type.description}</div>
            </div>
            <div>
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <Link
              ...
              className="flex w-full items-center justify-center rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white transition hover:bg-pm"
            >
              Edit Question
            </Link>
            <button
              onClick={onDuplicate}
              className="w-full rounded-lg border border-border px-4 py-2 text-sm font-semibold transition hover:bg-muted"
            >
              Duplicate
            </button>
            <button
              onClick={() => setShowDeleteModal(true)}
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-red-300 px-4 py-2 text-sm font-semibold text-red-600 transition hover:bg-red-50"
            >
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex items-center justify-between gap-3">
              <span className="text-sm text-inkd">Assessments</span>
              <span className="font-bold text-primary">{question.stats.usedInAssessments}</span>
            </div>
            <div className="flex items-center justify-between gap-3">
              <span className="text-sm text-inkd">Total Attempts</span>
              <span className="font-bold text-primary">{question.stats.totalAttempts}</span>
            </div>
