        ...
        <div className="grid gap-6 xl:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={(event) =>
                onChange("status", event.target.value as NewAssessmentFormData["status"])
              }
              className="w-full rounded-lg border border-border bg-card px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-pm"
            >
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={(event) =>
                onChange(
                  "participantIdentity",
                  event.target.value as NewAssessmentFormData["participantIdentity"],
                )
              }
              className="w-full rounded-lg border border-border bg-card px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-pm"
            >
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-primary">Owner Topic</label>
            <select
              value={formData.ownerTopicId}
              onChange={(event) => onChange("ownerTopicId", event.target.value)}
              className="w-full rounded-lg border border-border bg-card px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-pm"
            >
            ...
            <p className="text-xs text-inkd">Assign the primary topic owner for this assessment.</p>
          </div>
