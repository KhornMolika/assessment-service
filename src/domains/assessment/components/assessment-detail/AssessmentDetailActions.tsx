...
const playerSnippets: Record<PlayerCopyTarget, string> = {
  "self-paced": `import { AssessmentTakeScreen } from "@/src/domains/assessment/components/session/AssessmentSessionScreens";

<AssessmentTakeScreen
  assessment={assessment}
  questions={questions}
/>`,
  host: `import { AssessmentHostScreen } from "@/src/domains/assessment/components/session/AssessmentSessionScreens";
...
<AssessmentHostScreen
  ...
  embedded
/>`,
  participant: `import { AssessmentJoinScreen } from "@/src/domains/assessment/components/session/AssessmentSessionScreens";
