...
export async function getAssessmentCatalogPageData(): Promise<AssessmentCatalogPageData> {
  ...
  try {
    ...
    console.warn("Failed to fetch assessments:", e instanceof Error ? e.message : e);
  }
...
export async function getAssessmentDetailPageData(
  ...
  try {
    ...
    console.warn("Failed to fetch AssessmentDetailPageData:", err instanceof Error ? err.message : err);
    return null;
  }
}
...
export async function getAssessmentResultsPageData(): Promise<AssessmentResultsPageData> {
  ...
  try {
    ...
    console.warn("Failed getAssessmentResultsPageData:", err instanceof Error ? err.message : err);
    return {
...
export async function getAssessmentScopedResultsPageData(
  ...
  try {
    ...
    console.warn("Failed getAssessmentScopedResultsPageData:", err instanceof Error ? err.message : err);
    return null;
  }
}
...
export async function getEditAssessmentPageData(id: string): Promise<{
  ...
  try {
    ...
    console.warn("Failed getEditAssessmentPageData:", err instanceof Error ? err.message : err);
    throw err;
  }
}
...
export async function retryAIGrading(assessmentId: string, sessionId: string, entryId: string): Promise<boolean> {
  try {
    ...
    console.warn("Failed to retry AI grading:", err instanceof Error ? err.message : err);
    return false;
  }
}
